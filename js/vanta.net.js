!(function (t, e) {
    ...
    return (function (t) {
        ...
        0: function (t, e, i) {
            ...
            function o() {
                return "undefined" != typeof navigator ? /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || window.innerWidth < 768 : null;
            }
            i.d(e, "c", function () {
                return s;
            }),
                ...
                onInit() {
                    ...
                    for (let i = 0; i <= t; i++)
                        for (let s = 0; s <= t; s++) {
                            ...
                            i % 2 && (h += 0.5 * e), this.genPoint(r, n - Object(o.g)(5, 15), h), this.genPoint(r + Object(o.g)(-5, 5), n + Object(o.g)(5, 15), h + Object(o.g)(-5, 5));
                        }
                    (this.camera = new n.PerspectiveCamera(25, this.width / this.height, 0.01, 1e4)), this.camera.position.set(50, 100, 150), this.scene.add(this.camera);
